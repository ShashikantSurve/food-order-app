...
import com.surve_Food.service.FoodService;
import com.surve_Food.service.RestaurantService;
...
public class FoodController {
	...
	public ResponseEntity<List<Food>> getRestauranFood(@RequestParam boolean vegetarian, @RequestParam boolean seasonal,
			@RequestParam boolean nonveg, @PathVariable Long restaurantId,
